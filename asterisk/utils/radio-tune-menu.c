...
char	str[100],buf[256],*strs[100];
	...
	if (astgetline("radio tune menu-support 1",buf,sizeof(buf) - 1)) exit(255);
...
char	str[100];
	...
	for(;;)
	{
		if (astgetresp("radio tune menu-support b")) break;
		if (astgetresp("radio tune menu-support c")) break;
...
int	i,x;
	...
	if (astgetresp("radio tune menu-support e")) return;
...
int	i,x;
	...
	if (astgetresp("radio tune menu-support f")) return;
...
int	i,x;
	...
	if (astgetresp("radio tune menu-support g")) return;
...
int	i,x;
	...
	if (astgetresp("radio tune menu-support h")) return;
